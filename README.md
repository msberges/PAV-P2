...
- A la vista de la gráfica, indique qué valores considera adecuados para las magnitudes siguientes:
	...
	* Incremento del nivel potencia en dB, respecto al nivel correspondiente al silencio inicial, para
	  ...
	  Para estar seguros de que un segmento se la señal corresponde a voz y no silencio el incremento de nivel de potendia debería ser aproximadamente de unos 40dB.

	* Duración mínima razonable de los segmentos de voz y silencio.
	
	  El valor mínimo razonable nos parece ue debería ser de t = 0,5s aproximadamente.
