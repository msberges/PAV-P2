...
typedef struct {
  ...
  float zcr_0; /*Llindar de cruces por 0*/
  int min_voice;
  int min_silence;
  int maybe_cnt;
  int frame_cnt;
  float k0; /*Referència de potència de soroll*/
  float k1; /*Llindar entre soroll i undef*/
  float k2; /*Llindar entre veu i undef*/
  float alfa1; /*marge per k1*/
  float alfa2; /*marge per k2*/
} VAD_DATA;
